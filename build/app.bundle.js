...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var showShit = function showShit() {
	  ...
	  var targetAttribute = event.target.parentElement.dataset.skill;

	  var skillDesc = event.target.parentElement.parentElement.lastElementChild;
	 ...
	 */
	Array.from(newSkillItems, function (el) {
	  return el.firstElementChild.addEventListener('mouseenter', showShit, false), el.firstElementChild.addEventListener('mouseleave', showShit, false);
	});
	...
	*/
	var navLinkCollapsed = document.querySelector('.navigation-link-collapsed');
	var jsBurger = document.querySelector('.js-burger');
	var navLinkCollapsedA = document.querySelectorAll('.navigation-link-collapsed a');
	...
	*/
	...
	Array.from([jsBurger], function (el) {
	  return el.addEventListener('click', toggleBurger, false);
	});
	...
	*/
	...
	Array.from(navLinkCollapsedA, function (el) {
	  return el.addEventListener('click', toggleNavCollapse, false);
	});
	...
	*/
	var quoteLoop = function quoteLoop() {
	  var quoteArray = ["Courage is going from failure to failure, and not losing enthusiasm. -Winston Churchill", "Do not go where the path may lead, go instead where there is no path and leave a trail. -Ralph Waldo Emerson", "One idea can change your life. One idea can make your life better. -Les Brown", "Only those who will risk going too far can possibly find out how far one can go. -T.S. Elliot", "Sometimes things become possible if we want them bad enough. -T.S. Elliot", "Whatever you think, be sure it is what you think; whatever you want, be sure that is what you want; whatever you feel, be sure that is what you feel. -T.S. Elliot", "Unless you try to do something beyond what you have already mastered, you will never grow. -Ralph Waldo Emerson", "I have no special talent. I am only passionately curious. -Albert Einstein", "With one life to live, you ought to do more than just get by. -Richard Hamming", "It has often been said; The struggle to achieve excellence, is worth the struggle. -Richard Hamming", "The unexamined life is not worth living. -socrates"];
